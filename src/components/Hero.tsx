    ...
    <div className="hero-section">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 bg-gradient-to-r from-leap-navy to-leap-purple dark:from-leap-purple dark:to-leap-teal bg-clip-text text-transparent">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link to="/how-it-works">
              <Button
                variant="outline"
                className="border-leap-navy text-leap-navy hover:bg-leap-navy hover:text-white dark:border-leap-purple dark:text-leap-purple dark:hover:bg-leap-purple px-8 py-6 text-lg rounded-md w-full sm:w-auto"
              >
                Learn More
              </Button>
            </Link>
